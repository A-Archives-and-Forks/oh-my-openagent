...
| `src/reflection/` | Trigger evaluation, run reservation, worktree execution, completion validation, merge outcomes, and the orphan sweep that reclaims worktrees/branches no live run owns. |
