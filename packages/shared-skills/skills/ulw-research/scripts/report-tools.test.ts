...
describe("help and usage", () => {
	test("#given --help --json #when run #then it lists exactly the command matrix", async () => {
		...
		expect(COMMANDS).toEqual(["check", "layout-probe", "repair decide", "outcome init", "outcome set", "outcome gate", "outcome render", "outcome state", "outcome verify", "outcome briefing", "format-extract"])
	})
