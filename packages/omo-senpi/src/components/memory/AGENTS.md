...
| `sandbox.ts` | Seatbelt/bwrap sandbox transform for the detached reflection/facts children (`required|auto|off`, default `auto`). The in-process memorian judge never passes through it. |
