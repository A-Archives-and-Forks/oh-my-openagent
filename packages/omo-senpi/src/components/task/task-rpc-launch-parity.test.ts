...
/**
 * Admission can spend two full catalog probes whenever the first exit-0 listing omits the requested
 ...
 * admit.
 */
const ADMISSION_TEST_TIMEOUT_MS = PROBE_TIMEOUT_MS * 2 + 20_000
