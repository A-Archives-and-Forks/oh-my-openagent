...
export const KNOWN_MODELS = Object.freeze({
  ...
  "chatgpt-subscription": Object.freeze([
    "gpt-5.6-luna-fast", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-6-astra", "gpt-6-sol",
  ]),
  ...
  openai: Object.freeze(["gpt-5.6-luna-fast", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-6-astra", "gpt-6-sol"]),
  "openai-codex": Object.freeze([
    "gpt-5.6-luna-fast", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-6-astra", "gpt-6-sol",
  ]),
  opencode: Object.freeze([
    "claude-fable-5", "claude-fable-5-1", "claude-opus-4-6", "claude-opus-5", "claude-opus-5-5", "claude-sonnet-5", "gemini-3.1-pro",
    "gpt-5.6-sol", "gpt-5.6-terra", "gpt-6-astra", "gpt-6-sol", "grok-4.6", "kimi-k3",
  ]),
