...
| `plugin/` | The single Pi package `@code-yeongyu/omo-senpi`. It contains generated `extensions/omo.js`, the bundled Senpi `extensions/ultragoal.js`, generated skills, package metadata, and plugin-local build scripts. |
...
- `node packages/omo-senpi/plugin/scripts/build-extension.mjs` builds `plugin/extensions/omo.js`, `plugin/extensions/ultragoal.js`, and `plugin/extensions/omo-member.js`.
