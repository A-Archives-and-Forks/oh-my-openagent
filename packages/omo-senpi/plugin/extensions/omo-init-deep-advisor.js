...
</Category_Context>`}];var M=[{name:"visual-engineering",config:{model:"anthropic/claude-opus-5",variant:"max"},description:"Frontend, UI/UX, design, styling, animation",promptAppend:`<Category_Context>
...
</Category_Context>`}var Vt=`<Category_Context>
...
</Caller_Warning>`,Wt=`<Category_Context>
...
</Caller_Warning>`,A=[{name:"ultrabrain",config:{model:"openai/gpt-5.6-sol",variant:"max"},description:"Use ONLY for genuinely hard, logic-heavy tasks. Give clear goals only, not step-by-step instructions.",promptAppend:`<Category_Context>
...
Minimal status updates. Focus on results, not play-by-play. Report completion with summary of changes.
</Category_Context>`,resolvePromptAppend:kt,requiresModel:"gpt-5.6-sol"},{name:"quick",config:{model:"kimi-coding/kimi-for-coding-highspeed"},description:"Trivial tasks - single file changes, typo fixes, simple modifications",promptAppend:Vt},{name:"unspecified-low",config:{model:"openai/gpt-5.6-luna",variant:"xhigh"},description:"Tasks that don't fit other categories, low effort required",promptAppend:Wt}];var p=[...M,...A,...L,...y],ju=Object.fromEntries(p.map((t)=>[t.name,t.config])),Fu=Object.fromEntries(p.map((t)=>[t.name,t.description])),Ku=Object.fromEntries(p.map((t)=>[t.name,t.promptAppend]));function et(t){return t.requiresModel!==void 0}var Cu=Object.fromEntries(p.filter(et).map((t)=>[t.name,t.requiresModel]));var vu=Object.fromEntries(p.filter(jt).map((t)=>[t.name,t.resolvePromptAppend]));function jt(t){return t.resolvePromptAppend!==void 0}var l=Object.freeze({type:"boolean"}),r=Object.freeze({type:"number"}),x=Object.freeze({type:"string"});function s(t){return Object.freeze({type:"string",values:Object.freeze(t)})}var J=Object.freeze({anthropic:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),"anthropic-api":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),deepseek:Object.freeze(["deepseek-v4-flash","deepseek-v4-pro"]),google:Object.freeze(["gemini-3.6-flash"]),"github-copilot":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","gpt-5.6-sol","gpt-5.6-terra"]),"kimi-for-coding":Object.freeze(["k3","kimi-for-coding-highspeed","kimi-k3"]),moonshotai:Object.freeze(["kimi-k3"]),openai:Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),opencode:Object.freeze(["claude-opus-5","claude-sonnet-5","gpt-5.6-sol","kimi-k3"]),"opencode-go":Object.freeze(["deepseek-v4-pro","kimi-k3","minimax-m2.7","minimax-m3"]),"quotio-openai":Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),vercel:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","deepseek-v4-flash","deepseek-v4-pro","gemini-3.6-flash","gpt-5.6-sol","gpt-5.6-terra","kimi-k3","minimax-m2.7","minimax-m3"]),xai:Object.freeze(["grok-4.20-0309-non-reasoning"])}),G=Object.freeze(Object.keys(J)),Kt=Object.freeze([...v]),Ct=Object.freeze(p.map(({name:t})=>t)),vt=Object.freeze(["ast-grep","coding-agent-sessions","data-scientist","debugging","frontend","git-master","give-me-tips","hyperplan","init-deep","lsp-setup","onboarding","programming","refactor","remove-ai-slops","review-work","start-work","ultimate-browsing","ultrawork","ulw-loop","ulw-plan","ulw-research","visual-qa"]),Lt=Object.freeze({daily_active:Object.freeze({$session_id:x,day_utc:x,reason:s(["session_start"])}),session_started:Object.freeze({$session_id:x,$os:x,$os_version:x,arch:x,cpu_count:r,default_model:s([...new Set(Object.values(J).flat()),"custom"]),default_provider:s([...G,"custom"]),memory_bucket:s(["lt_8_gb","8_15_gb","16_31_gb","32_63_gb","64_plus_gb"]),model_count:r,provider_count:r,providers:x,reason:s(["startup","reload","new","resume","fork"])}),prompt_submitted:Object.freeze({$session_id:x,input_source:s(["interactive","rpc","extension"]),invocation_stage:s(["none","first_arm","remention","post_compact_rearm"]),is_effective_ultrawork_invocation:l,is_real_user_prompt:l,is_turn_start:l,keyword_any:l,keyword_occurrence_bucket:s(["1","2","3_5","6_plus"]),keyword_ultrawork_full:l,keyword_ulw_abbrev:l,keyword_variant:s(["none","ulw","ultrawork","both"]),prompt_length_bucket:s(["lt_100","100_500","500_2000","gte_2000"]),queue_mode:s(["immediate","follow_up","steer","other"]),real_prompt_ordinal_bucket:s(["1","2_3","4_10","11_25","26_plus"]),suppression_reason:s(["none","no_keyword","extension_source","embedded_directive","skill_expansion","skill_name_only"])}),turn_completed:Object.freeze({$session_id:x,cache_read_tokens:r,cache_write_tokens:r,cost_usd:r,input_tokens:r,model_id:s([...new Set(Object.values(J).flat()),"custom"]),output_tokens:r,provider:s([...G,"custom"]),reasoning_tokens:r,total_tokens:r,turn_index:r}),skill_loaded:Object.freeze({$session_id:x,skill_name:s(vt)}),delegation_started:Object.freeze({$session_id:x,background:l,batch_size_bucket:s(["1","2_4","5_plus"]),kind:s(["category","subagent"]),name:s([...Ct,...Kt,"custom"])}),feature_used:Object.freeze({$session_id:x,feature:s(["goal_tool","team_create","memory_tool"])}),parallelism_summary:Object.freeze({$session_id:x,clock_anomalies:r,dropped_calls:r,eval_only_duration_ms:r,eval_only_waves:r,incomplete_calls:r,measured_turn_duration_ms_total:r,mixed_waves:r,modeled_wallclock_saved_ms:r,non_eval_joined_calls:r,non_eval_saved_round_trips:r,non_eval_wave_size_histogram:x,non_eval_waves_multi:r,non_eval_waves_total:r,schema_kind:s(["parallelism_v1"]),upper_bound_saved_ms:r})}),Iu=Object.freeze(Object.fromEntries(Object.entries(Lt).map(([t,u])=>[t,Object.freeze(Object.keys(u))])));function U(){return Ft(new URL("../skills/",import.meta.url))}import{existsSync as cu}from"node:fs";import{join as ru}from"node:path";var B=0.5,I=8,Y=500,T=3,D=30,X=0.15,H=0.25,$=90,d=7,z=86400000,Z=new Set([".ts",".tsx",".js",".jsx",".py",".go",".rs",".java",".kt",".swift",".rb",".php",".c",".cpp",".cs",".scala",".lua",".ex",".exs",".zig",".dart"]),_=new Set(["node_modules",".git","dist","build","vendor",".next","__pycache__",".venv","target","coverage","third_party"]);import{existsSync as Mt,readdirSync as yt,readFileSync as At}from"node:fs";import{dirname as Gt,extname as Ut,join as k}from"node:path";function Bt(t,u){let n=u;for(;;){if(Mt(k(n,"AGENTS.md")))return!0;if(n===t)return!1;let i=Gt(n);if(i===n)return!1;n=i}}function It(t){let u=[];return E(t,t,0,u),u}function N(t){let u=It(t);if(u.length===0)return null;let n=u.filter((c)=>c.covered).length,i=n/u.length;return{coverage:i,missingRatio:1-i,candidateDirs:u.length,coveredDirs:n}}function O(t,u){if(t===null)return!1;return t>=B}function E(t,u,n,i){if(n>T)return;let c;try{c=yt(u,{withFileTypes:!0})}catch{return}if(n>=1){let g=c.filter((m)=>!m.isSymbolicLink()&&m.isFile()&&Z.has(Ut(m.name))),f=g.reduce((m,b)=>m+At(k(u,b.name),"utf8").split(`
`).length,0);if(g.length>=I||f>=Y)i.push({path:u,files:g.length,loc:f,covered:Bt(t,u)})}for(let g of c){if(g.isSymbolicLink()||!g.isDirectory())continue;if(_.has(g.name))continue;E(t,k(u,g.name),n+1,i)}}import{execFileSync as Yt}from"node:child_process";import{readFileSync as Tt,realpathSync as au}from"node:fs";import{extname as dt,join as _t,resolve as tn}from"node:path";var R=[":(exclude)AGENTS.md",":(exclude,glob)**/AGENTS.md",":(exclude).omo/init-deep.json"];function w(t,u){return Yt("git",[...u],{cwd:t,encoding:"utf8"})}function Nt(t){let u=0;for(let n of t)if(n==="\x00")u+=1;return u}function a(t){return w(t,["rev-parse","HEAD"]).trim()}function P(t,u){return Number(w(t,["rev-list","--count",`${u}..HEAD`]).trim())}function tt(t){return Nt(w(t,["ls-files","-z"]))}function ut(t,u){return w(t,["diff","--name-only","-z","--find-renames",u,"HEAD","--",".",...R]).split("\x00").filter((i)=>i.length>0)}function nt(t,u){let i=w(t,["diff","--numstat","-z","--find-renames",u,"HEAD","--",".",...R]).split("\x00"),c=0;for(let g=0;g<i.length;g+=1){let f=i[g];if(f.length===0)continue;let[m,b,h]=f.split("\t");if(h==="")g+=2;if(m==="-"||b==="-")continue;c+=Number(m)+Number(b)}return c}function it(t){let u=w(t,["ls-files","-z"]).split("\x00").filter((i)=>i.length>0&&Z.has(dt(i))),n=0;for(let i of u){let c=Tt(_t(t,i),"utf8");for(let g of c)if(g===`
`)n+=1}return n}function gt(t,u){try{return w(t,["cat-file","-t",u]).trim()}catch{return null}}function ct(t,u){if(gt(t,u.commitSha)!=="commit")return{kind:"stale",stale:!0};let n=P(t,u.commitSha),i=ut(t,u.commitSha).length,c=tt(t),g=nt(t,u.commitSha),f=it(t);return{kind:"valid",commitsSince:n,touchedFiles:i,trackedFiles:c,touchedRatio:i/Math.max(c,1),churnLoc:g,totalLoc:f,churnLocRatio:g/Math.max(f,1),daysSince:(Date.now()-u.timestamp)/z}}function V(t,u,n,i){if(u===n)return!1;if(Date.now()<i)return!1;if(t.kind==="stale")return!0;return t.commitsSince>=D&&t.touchedRatio>=X||t.churnLocRatio>=H||t.daysSince>=$}import{execFileSync as Ot}from"node:child_process";import{createHash as Et,randomUUID as Rt}from"node:crypto";import{existsSync as rt,mkdirSync as q,readFileSync as ft,realpathSync as at,renameSync as Pt,unlinkSync as tu,writeFileSync as uu}from"node:fs";import{join as o,resolve as nu}from"node:path";var st="init-deep-advisor-declined-global",mt="init-deep-advisor-declined-projects",xt="init-deep-advisor-cooldowns",ot="init-deep-advisor-proposals",iu=o(".omo","init-deep.json");function bt(t){let u=Ot("git",["rev-parse","--git-common-dir"],{cwd:t,encoding:"utf8"}).trim();return Et("sha256").update(at(nu(t,u))).digest("hex")}function pt(t){q(t,{recursive:!0}),Q(o(t,st),JSON.stringify({declinedAt:Date.now()}))}function lt(t){try{return rt(o(t,st))}catch{return!1}}function wt(t,u){let n=o(t,mt);q(n,{recursive:!0}),Q(o(n,u),JSON.stringify({declinedAt:Date.now()}))}function Dt(t,u){try{return rt(o(t,mt,u))}catch{return!1}}function Xt(t,u,n){let i=o(t,xt);q(i,{recursive:!0}),Q(o(i,u),JSON.stringify({until:n+d*z}))}function Ht(t,u){let n=qt(o(t,xt,u));if(!S(n))return 0;let i=n.until;if(typeof i!=="number"||!Number.isFinite(i)||i<0)return 0;return i}function $t(t,u,n){let i=o(t,ot);q(i,{recursive:!0}),Q(o(i,u),JSON.stringify({lastProposedHead:n,lastProposedAt:Date.now()}))}function zt(t,u){let n=qt(o(t,ot,u));if(!S(n))return null;let i=n.lastProposedHead;return typeof i==="string"?i:null}function Zt(t){let u;try{u=ft(o(t,iu),"utf8")}catch(b){return gu(b)==="ENOENT"?{kind:"missing"}:{kind:"invalid"}}let n;try{n=JSON.parse(u)}catch{return{kind:"invalid"}}if(!S(n))return{kind:"invalid"};let{commitSha:i,fileCount:c,loc:g,timestamp:f,mode:m}=n;if(typeof i!=="string")return{kind:"invalid"};if(!W(c)||!W(g)||!W(f))return{kind:"invalid"};if(m!=="local"&&m!=="committed")return{kind:"invalid"};return{kind:"valid",snapshot:{commitSha:i,fileCount:c,loc:g,timestamp:f,mode:m}}}function Q(t,u){let n=`${t}.${process.pid}.${Rt()}.tmp`;try{uu(n,u,{mode:384}),Pt(n,t)}finally{try{tu(n)}catch{}}}function qt(t){try{return JSON.parse(ft(t,"utf8"))}catch{return}}function W(t){return typeof t==="number"&&Number.isFinite(t)&&t>=0}function gu(t){if(!S(t))return;let u=t.code;return typeof u==="string"?u:void 0}function S(t){return t!==null&&typeof t==="object"&&!Array.isArray(t)}function Qt(t,u,n,i){let c=Zt(t);if(c.kind==="missing"){let f=N(t);if(!O(f?.missingRatio??null,cu(ru(t,"AGENTS.md"))))return null;if(u===n||Date.now()<i)return null;return{trigger:"coverage-gap",coverage:{missingRatio:f.missingRatio,candidateDirs:f.candidateDirs,coveredDirs:f.coveredDirs}}}if(c.kind==="invalid")return fu(u,n,i);let g=ct(t,c.snapshot);if(!V(g,u,n,i))return null;if(g.kind==="stale")return{trigger:"snapshot-invalid",drift:{stale:!0}};return su(g)}function fu(t,u,n){if(!V({kind:"stale",stale:!0},t,u,n))return null;return{trigger:"snapshot-invalid",drift:{stale:!0}}}function su(t){let u={commitsSince:t.commitsSince,touchedRatio:t.touchedRatio,churnLocRatio:t.churnLocRatio,daysSince:t.daysSince};if(t.commitsSince>=D&&t.touchedRatio>=X)return{trigger:"commit-and-touch",drift:u};if(t.churnLocRatio>=H)return{trigger:"loc-churn",drift:u};if(t.daysSince>=$)return{trigger:"snapshot-age",drift:u};throw Error("eligible drift has no trigger")}function St(t,u,n){if(u.trigger==="coverage-gap")return{repo:t,trigger:u.trigger,coverage:u.coverage,drift:null,suggestedMode:n};if(u.trigger==="snapshot-invalid")return{repo:t,trigger:u.trigger,coverage:null,drift:u.drift,suggestedMode:n};return{repo:t,trigger:u.trigger,coverage:null,drift:u.drift,suggestedMode:n}}var xu=["Run now","Skip this time","Never in this project","Never anywhere"];async function Wn(t,u,n){let{root:i,stateDir:c}=n,g=bt(i);if(lt(c))return;if(Dt(c,g))return;let f=Ht(c,g);if(Date.now()<f)return;let m=a(i),b=Qt(i,m,zt(c,g),f);if(b===null)return;$t(c,g,m),await new Promise((ht)=>setTimeout(ht,0));let h=await u.ui?.select("Init-deep",[...xu],{timeout:60000});ou(h,t,c,g,i,b)}function ou(t,u,n,i,c,g){if(t==="Run now"){let f=U();u.sendMessage({customType:"omo-init-deep-advisor:run",content:`Read the init-deep skill at ${f}/init-deep/SKILL.md with the read tool and follow it.`,display:!1},{triggerTurn:!0,deliverAs:"followUp"}),u.appendEntry?.("omo-init-deep-advisor:proposed",St(i,g,bu(c)));return}if(t==="Skip this time"||t===void 0){Xt(n,i,Date.now());return}if(t==="Never in this project"){wt(n,i);return}if(t==="Never anywhere")pt(n)}function bu(t){try{return mu("git",["ls-files","--error-unmatch","AGENTS.md"],{cwd:t,encoding:"utf8",stdio:["ignore","pipe","ignore"]}),"committed"}catch{return"local"}}export{Wn as runAdvisorAfterPreflight};
