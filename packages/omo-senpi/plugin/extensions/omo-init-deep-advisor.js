// omo:IFbrNHnSZM-VXUzJ4CjAea8f1hRhW73UHuNKK2rh8ik:suuoxcsA_AouT_sNZo2cuOeln6og94IY95LeYRvxpCs
...
Minimal status updates. Focus on results, not play-by-play. Report completion with summary of changes.
</Category_Context>`,resolvePromptAppend:Ie,requiresModel:"gpt-5.6-sol"},{name:"quick",config:{model:"kimi-coding/kimi-for-coding-highspeed"},description:"Trivial tasks - single file changes, typo fixes, simple modifications",promptAppend:xe},{name:"unspecified-low",config:{model:"xai/grok-4.6",variant:"xhigh"},description:"Tasks that don't fit other categories, low effort required",promptAppend:ke}];var m=[...U,...G,...L,...Y],Ct=Object.fromEntries(m.map((e)=>[e.name,e.config])),Dt=Object.fromEntries(m.map((e)=>[e.name,e.description])),Pt=Object.fromEntries(m.map((e)=>[e.name,e.promptAppend]));function Ne(e){return e.requiresModel!==void 0}var Mt=Object.fromEntries(m.filter(Ne).map((e)=>[e.name,e.requiresModel]));var Lt=Object.fromEntries(m.filter(Ce).map((e)=>[e.name,e.resolvePromptAppend]));function Ce(e){return e.resolvePromptAppend!==void 0}var h=Object.freeze({type:"boolean"}),s=Object.freeze({type:"number"}),d=Object.freeze({type:"string"});function c(e){return Object.freeze({type:"string",values:Object.freeze(e)})}var R=Object.freeze({anthropic:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),"anthropic-api":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5"]),deepseek:Object.freeze(["deepseek-v4-flash","deepseek-v4-pro"]),google:Object.freeze(["gemini-3.6-flash"]),"github-copilot":Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","gpt-5.6-sol","gpt-5.6-terra"]),"kimi-for-coding":Object.freeze(["k3","kimi-for-coding-highspeed","kimi-k3"]),moonshotai:Object.freeze(["kimi-k3"]),openai:Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),opencode:Object.freeze(["claude-opus-5","claude-sonnet-5","gpt-5.6-sol","kimi-k3"]),"opencode-go":Object.freeze(["deepseek-v4-pro","kimi-k3","minimax-m2.7","minimax-m3"]),"quotio-openai":Object.freeze(["gpt-5.6-luna-fast","gpt-5.6-sol","gpt-5.6-terra"]),vercel:Object.freeze(["claude-fable-5","claude-haiku-4-5","claude-opus-5","claude-sonnet-5","deepseek-v4-flash","deepseek-v4-pro","gemini-3.6-flash","gpt-5.6-sol","gpt-5.6-terra","kimi-k3","minimax-m2.7","minimax-m3"]),xai:Object.freeze(["grok-4.20-0309-non-reasoning"])}),H=Object.freeze(Object.keys(R)),Pe=Object.freeze([...M]),Me=Object.freeze(m.map(({name:e})=>e)),Le=Object.freeze(["ast-grep","coding-agent-sessions","data-scientist","debugging","frontend","git-master","give-me-tips","hyperplan","init-deep","lsp-setup","mass-ulw","onboarding","programming","refactor","remove-ai-slops","review-work","start-work","ultimate-browsing","ultrawork","ulw-loop","ulw-plan","ulw-research","visual-qa"]),Ue=Object.freeze({daily_active:Object.freeze({$session_id:d,day_utc:d,reason:c(["session_start"])}),session_started:Object.freeze({$session_id:d,$os:d,$os_version:d,arch:d,cpu_count:s,default_model:c([...new Set(Object.values(R).flat()),"custom"]),default_provider:c([...H,"custom"]),memory_bucket:c(["lt_8_gb","8_15_gb","16_31_gb","32_63_gb","64_plus_gb"]),model_count:s,provider_count:s,providers:d,reason:c(["startup","reload","new","resume","fork"])}),prompt_submitted:Object.freeze({$session_id:d,input_source:c(["interactive","rpc","extension"]),invocation_stage:c(["none","first_arm","remention","post_compact_rearm"]),is_effective_ultrawork_invocation:h,is_real_user_prompt:h,is_turn_start:h,keyword_any:h,keyword_occurrence_bucket:c(["1","2","3_5","6_plus"]),keyword_ultrawork_full:h,keyword_ulw_abbrev:h,keyword_variant:c(["none","ulw","ultrawork","both"]),prompt_length_bucket:c(["lt_100","100_500","500_2000","gte_2000"]),queue_mode:c(["immediate","follow_up","steer","other"]),real_prompt_ordinal_bucket:c(["1","2_3","4_10","11_25","26_plus"]),suppression_reason:c(["none","no_keyword","extension_source","embedded_directive","skill_expansion","skill_name_only"])}),turn_completed:Object.freeze({$session_id:d,cache_read_tokens:s,cache_write_tokens:s,cost_usd:s,input_tokens:s,model_id:c([...new Set(Object.values(R).flat()),"custom"]),output_tokens:s,provider:c([...H,"custom"]),reasoning_tokens:s,total_tokens:s,turn_index:s}),skill_loaded:Object.freeze({$session_id:d,skill_name:c(Le)}),delegation_started:Object.freeze({$session_id:d,background:h,batch_size_bucket:c(["1","2_4","5_plus"]),kind:c(["category","subagent"]),name:c([...Me,...Pe,"custom"])}),feature_used:Object.freeze({$session_id:d,feature:c(["goal_tool","team_create","memory_tool"])}),parallelism_summary:Object.freeze({$session_id:d,clock_anomalies:s,dropped_calls:s,eval_only_duration_ms:s,eval_only_waves:s,incomplete_calls:s,measured_turn_duration_ms_total:s,mixed_waves:s,modeled_wallclock_saved_ms:s,non_eval_joined_calls:s,non_eval_saved_round_trips:s,non_eval_wave_size_histogram:d,non_eval_waves_multi:s,non_eval_waves_total:s,schema_kind:c(["parallelism_v1"]),upper_bound_saved_ms:s})}),Wt=Object.freeze(Object.fromEntries(Object.entries(Ue).map(([e,t])=>[e,Object.freeze(Object.keys(t))])));function F(){return De(new URL("../skills/",import.meta.url))}import{existsSync as st}from"node:fs";import{join as at}from"node:path";var j=0.5,B=8,W=500,q=3,g=30,y=0.15,E=0.25,b=90,V=7,T=86400000,v=new Set([".ts",".tsx",".js",".jsx",".py",".go",".rs",".java",".kt",".swift",".rb",".php",".c",".cpp",".cs",".scala",".lua",".ex",".exs",".zig",".dart"]),z=new Set(["node_modules",".git","dist","build","vendor",".next","__pycache__",".venv","target","coverage","third_party"]);import{existsSync as Ye,readdirSync as Ge,readFileSync as He}from"node:fs";import{dirname as Fe,extname as je,join as w}from"node:path";function Be(e,t){let n=t;for(;;){if(Ye(w(n,"AGENTS.md")))return!0;if(n===e)return!1;let o=Fe(n);if(o===n)return!1;n=o}}function We(e){let t=[];return Q(e,e,0,t),t}function K(e){let t=We(e);if(t.length===0)return null;let n=t.filter((r)=>r.covered).length,o=n/t.length;return{coverage:o,missingRatio:1-o,candidateDirs:t.length,coveredDirs:n}}function X(e,t){if(e===null)return!1;return e>=j}function Q(e,t,n,o){if(n>q)return;let r;try{r=Ge(t,{withFileTypes:!0})}catch{return}if(n>=1){let i=r.filter((l)=>!l.isSymbolicLink()&&l.isFile()&&v.has(je(l.name))),a=i.reduce((l,p)=>l+He(w(t,p.name),"utf8").split(`
`).length,0);if(i.length>=B||a>=W)o.push({path:t,files:i.length,loc:a,covered:Be(e,t)})}for(let i of r){if(i.isSymbolicLink()||!i.isDirectory())continue;if(z.has(i.name))continue;Q(e,w(t,i.name),n+1,o)}}import{execFileSync as qe}from"node:child_process";import{readFileSync as Ve,realpathSync as Zt}from"node:fs";import{extname as ze,join as Ke,resolve as tn}from"node:path";var J=[":(exclude)AGENTS.md",":(exclude,glob)**/AGENTS.md",":(exclude).omo/init-deep.json"];function f(e,t){return qe("git",[...t],{cwd:e,encoding:"utf8"})}function Xe(e){let t=0;for(let n of e)if(n==="\x00")t+=1;return t}function Z(e){return f(e,["rev-parse","HEAD"]).trim()}function ee(e,t){return Number(f(e,["rev-list","--count",`${t}..HEAD`]).trim())}function te(e){return Xe(f(e,["ls-files","-z"]))}function ne(e,t){return f(e,["diff","--name-only","-z","--find-renames",t,"HEAD","--",".",...J]).split("\x00").filter((o)=>o.length>0)}function oe(e,t){let o=f(e,["diff","--numstat","-z","--find-renames",t,"HEAD","--",".",...J]).split("\x00"),r=0;for(let i=0;i<o.length;i+=1){let a=o[i];if(a.length===0)continue;let[l,p,O]=a.split("\t");if(O==="")i+=2;if(l==="-"||p==="-")continue;r+=Number(l)+Number(p)}return r}function ie(e){let t=f(e,["ls-files","-z"]).split("\x00").filter((o)=>o.length>0&&v.has(ze(o))),n=0;for(let o of t){let r=Ve(Ke(e,o),"utf8");for(let i of r)if(i===`
`)n+=1}return n}function re(e,t){try{return f(e,["cat-file","-t",t]).trim()}catch{return null}}function se(e,t){if(re(e,t.commitSha)!=="commit")return{kind:"stale",stale:!0};let n=ee(e,t.commitSha),o=ne(e,t.commitSha).length,r=te(e),i=oe(e,t.commitSha),a=ie(e);return{kind:"valid",commitsSince:n,touchedFiles:o,trackedFiles:r,touchedRatio:o/Math.max(r,1),churnLoc:i,totalLoc:a,churnLocRatio:i/Math.max(a,1),daysSince:(Date.now()-t.timestamp)/T}}function I(e,t,n,o){if(t===n)return!1;if(Date.now()<o)return!1;if(e.kind==="stale")return!0;return e.commitsSince>=g&&e.touchedRatio>=y||e.churnLocRatio>=E||e.daysSince>=b}import{execFileSync as Qe}from"node:child_process";import{createHash as Je,randomUUID as $e}from"node:crypto";import{existsSync as ae,mkdirSync as S,readFileSync as ce,realpathSync as Ze,renameSync as et,unlinkSync as tt,writeFileSync as nt}from"node:fs";import{join as u,resolve as ot}from"node:path";var le="init-deep-advisor-declined-global",de="init-deep-advisor-declined-projects",ue="init-deep-advisor-cooldowns",pe="init-deep-advisor-proposals",it=u(".omo","init-deep.json");function me(e){let t=Qe("git",["rev-parse","--git-common-dir"],{cwd:e,encoding:"utf8"}).trim();return Je("sha256").update(Ze(ot(e,t))).digest("hex")}function he(e){S(e,{recursive:!0}),A(u(e,le),JSON.stringify({declinedAt:Date.now()}))}function fe(e){try{return ae(u(e,le))}catch{return!1}}function ge(e,t){let n=u(e,de);S(n,{recursive:!0}),A(u(n,t),JSON.stringify({declinedAt:Date.now()}))}function ye(e,t){try{return ae(u(e,de,t))}catch{return!1}}function Ee(e,t,n){let o=u(e,ue);S(o,{recursive:!0}),A(u(o,t),JSON.stringify({until:n+V*T}))}function be(e,t){let n=Ae(u(e,ue,t));if(!_(n))return 0;let o=n.until;if(typeof o!=="number"||!Number.isFinite(o)||o<0)return 0;return o}function Te(e,t,n){let o=u(e,pe);S(o,{recursive:!0}),A(u(o,t),JSON.stringify({lastProposedHead:n,lastProposedAt:Date.now()}))}function ve(e,t){let n=Ae(u(e,pe,t));if(!_(n))return null;let o=n.lastProposedHead;return typeof o==="string"?o:null}function Se(e){let t;try{t=ce(u(e,it),"utf8")}catch(p){return rt(p)==="ENOENT"?{kind:"missing"}:{kind:"invalid"}}let n;try{n=JSON.parse(t)}catch{return{kind:"invalid"}}if(!_(n))return{kind:"invalid"};let{commitSha:o,fileCount:r,loc:i,timestamp:a,mode:l}=n;if(typeof o!=="string")return{kind:"invalid"};if(!x(r)||!x(i)||!x(a))return{kind:"invalid"};if(l!=="local"&&l!=="committed")return{kind:"invalid"};return{kind:"valid",snapshot:{commitSha:o,fileCount:r,loc:i,timestamp:a,mode:l}}}function A(e,t){let n=`${e}.${process.pid}.${$e()}.tmp`;try{nt(n,t,{mode:384}),et(n,e)}finally{try{tt(n)}catch{}}}function Ae(e){try{return JSON.parse(ce(e,"utf8"))}catch{return}}function x(e){return typeof e==="number"&&Number.isFinite(e)&&e>=0}function rt(e){if(!_(e))return;let t=e.code;return typeof t==="string"?t:void 0}function _(e){return e!==null&&typeof e==="object"&&!Array.isArray(e)}function _e(e,t,n,o){let r=Se(e);if(r.kind==="missing"){let a=K(e);if(!X(a?.missingRatio??null,st(at(e,"AGENTS.md"))))return null;if(t===n||Date.now()<o)return null;return{trigger:"coverage-gap",coverage:{missingRatio:a.missingRatio,candidateDirs:a.candidateDirs,coveredDirs:a.coveredDirs}}}if(r.kind==="invalid")return ct(t,n,o);let i=se(e,r.snapshot);if(!I(i,t,n,o))return null;if(i.kind==="stale")return{trigger:"snapshot-invalid",drift:{stale:!0}};return lt(i)}function ct(e,t,n){if(!I({kind:"stale",stale:!0},e,t,n))return null;return{trigger:"snapshot-invalid",drift:{stale:!0}}}function lt(e){let t={commitsSince:e.commitsSince,touchedRatio:e.touchedRatio,churnLocRatio:e.churnLocRatio,daysSince:e.daysSince};if(e.commitsSince>=g&&e.touchedRatio>=y)return{trigger:"commit-and-touch",drift:t};if(e.churnLocRatio>=E)return{trigger:"loc-churn",drift:t};if(e.daysSince>=b)return{trigger:"snapshot-age",drift:t};throw Error("eligible drift has no trigger")}function Oe(e,t,n){if(t.trigger==="coverage-gap")return{repo:e,trigger:t.trigger,coverage:t.coverage,drift:null,suggestedMode:n};if(t.trigger==="snapshot-invalid")return{repo:e,trigger:t.trigger,coverage:null,drift:t.drift,suggestedMode:n};return{repo:e,trigger:t.trigger,coverage:null,drift:t.drift,suggestedMode:n}}var ut=["Run now","Skip this time","Never in this project","Never anywhere"];async function kn(e,t,n){let{root:o,stateDir:r}=n,i=me(o);if(fe(r))return;if(ye(r,i))return;let a=be(r,i);if(Date.now()<a)return;let l=Z(o),p=_e(o,l,ve(r,i),a);if(p===null)return;Te(r,i,l),await new Promise((Re)=>setTimeout(Re,0));let O=await t.ui?.select("Init-deep",[...ut],{timeout:60000});pt(O,e,r,i,o,p)}function pt(e,t,n,o,r,i){if(e==="Run now"){let a=F();t.sendMessage({customType:"omo-init-deep-advisor:run",content:`Read the init-deep skill at ${a}/init-deep/SKILL.md with the read tool and follow it.`,display:!1},{triggerTurn:!0,deliverAs:"followUp"}),t.appendEntry?.("omo-init-deep-advisor:proposed",Oe(o,i,mt(r)));return}if(e==="Skip this time"||e===void 0){Ee(n,o,Date.now());return}if(e==="Never in this project"){ge(n,o);return}if(e==="Never anywhere")he(n)}function mt(e){try{return dt("git",["ls-files","--error-unmatch","AGENTS.md"],{cwd:e,encoding:"utf8",stdio:["ignore","pipe","ignore"]}),"committed"}catch{return"local"}}export{kn as runAdvisorAfterPreflight};
