...
export type TaskRecord = TaskRecordInput & {
  ...
  // Durable launch boundary, committed by start before runner.start. Later outcomes (including
  // lost) preserve it. Absent on never-launched tasks and records written before this field shipped.
