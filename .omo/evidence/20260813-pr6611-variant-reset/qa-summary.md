...
- The exact source-loaded `dist/index.js` was rebuilt after the variant fix,
  hashed as `e233a184ab118b3fb442831d4d42f0f5460c13948c8ab6451b121a09efdf7fdb`,
  ...
  fallback indexing, category-inherited variant resolution, explicit-variant
  precedence, capability-aware reasoning lowering, and defined
  replacement-state identity guards before OpenCode started.
...
- The driver captured `/tmp/oqa-xdg.t5A9XY`, the helper's actual `oqa-xdg.*`
